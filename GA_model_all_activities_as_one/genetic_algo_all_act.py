...
from GA_model_all_activities_as_one.objective_all_act_ga import objective_all_act_ga
...
def genetic_algorithm_all_act(args, all_mod_eval_output, bounds, n_bits, termin_iter, max_iter, n_pop, r_cross, r_mut, log_dir, sbj):
	...
	score, f_one, f_one_target,\
		data_saved_ratio, comp_saved_ratio,\
				...
				f_one_gt_mod_val_avg, f_one_gt_val_avg = objective_all_act_ga(args, h_param, all_mod_eval_output)
