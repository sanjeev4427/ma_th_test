...
def plot_sensordata_and_labels(datasetname, all_mod_eval_output, all_mod_val_preds):
    import numpy as np
    import matplotlib.patches as mpatches
    ...
    ax1.pcolor([labels_onehot], cmap=cmap1)
    ...
    plt.savefig(
        rf'C:\Users\minio\Box\Thesis- Marius\aaimss_thesis\figures\activities_vs_time_{datasetname}.png',
        format="png",
        bbox_inches="tight",
    )
    plt.show()
...
# data = pd.read_csv(r'C:\Thesis_large_files\rwhar_data.csv')
