...
from SA_model_not_activity_wise.skip_heuristics_all_act import skip_heuristics_all_act
...
def loss_function_all_act(f_alpha, c_alpha, d_alpha, f_one, f_one_target, f_one_gt_val, f_one_gt_mod_val_avg, comp_saved_ratio,data_saved_ratio):
...
def anneal_objective_all_act(args, h_param, all_mod_eval_output):
    ...
    f_one_gt_mod_val,  f_one_gt_val, f_one_val_mod_val, f_one_gt_mod_val_avg, f_one_gt_val_avg\
        = skip_heuristics_all_act(args, window_threshold, skip_windows, tolerance_value, all_mod_eval_output)  
    ...
    loss = loss_function_all_act(f_alpha, c_alpha, d_alpha, f_one, f_one_target, f_one_gt_val, f_one_gt_mod_val_avg, comp_saved_ratio, data_saved_ratio)
...
def simulated_annealing_all_act(args, window_threshold, skip_windows,\
                          tol_value, max_step_size_win_thr, max_step_size_skip_win, max_step_size_tol_val, \
                            init_temp, ann_rate, log_folder_name, all_mod_eval_output,sbj):
    ...
    best_eval, best_f1, f_one_target, best_data_saved, best_comp_saved,\
                        f_one_gt_mod_val,  f_one_gt_val, f_one_val_mod_val,\
                             f_one_gt_mod_val_avg, f_one_gt_val_avg = anneal_objective_all_act(args, best, all_mod_eval_output)
    ...
    while True:
        ...
        while acceptance_ratio < 0.1:
            ...
            candidate_eval, candidate_f1, f_one_target, candidate_data_saved, candidate_comp_saved, \
                                    f_one_gt_mod_val,  f_one_gt_val, f_one_val_mod_val,\
                                    f_one_gt_mod_val_avg, f_one_gt_val_avg \
                                        = anneal_objective_all_act(args, candidate, all_mod_eval_output)
    ...
    return best, best_eval[0], best_f1, f_one_target, round(best_data_saved,2), round(best_comp_saved,2), best_f_one_gt_mod_val,  best_f_one_gt_val, best_f_one_val_mod_val,\
