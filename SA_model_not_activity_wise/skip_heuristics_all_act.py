...
def skip_heuristics_all_act(args, window_threshold, skip_windows, tolerance_value, all_eval_output):
    """
    ...
    all_mod_val_preds, data_saved, computations_saved = data_skipping_all_act(
    ...
    return f_one_gt_mod_val,  f_one_gt_val, f_one_val_mod_val, f_one_gt_mod_val_avg, f_one_gt_val_avg
